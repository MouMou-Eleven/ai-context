...
用户说“参考我 GitHub 仓库里的语言风格”“参考语言表达习惯”“参考语言类案例”“按我沉淀的表达和讲解经验来写”“减少 AI 味”时，读取 `expression/trigger-rules.md` 和 `expression/README.md`。调用按方法语义进行，不要求用户记住“飞天闪客”等来源作者姓名。来源材料只用于追溯和继续提炼，不机械仿写。

表达触发词可以与业务词组合：自媒体相关词进入当前自媒体项目，培训学员、培训课程和 AI 培训等词进入 `projects/ai-training/`，微课、精品课和教师委托等词进入 `projects/microcourse/`。业务规则决定内容边界，表达方法只决定怎样写。
