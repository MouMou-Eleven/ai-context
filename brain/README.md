...
│   │                           思维认知、判断习惯、学习与决策方式
│   └── business-cognition.md   商业、增长与内容经营认知
...
| 层级 | 负责什么 | 什么时候调用 |
|---|---|---|
| 建委认知 | 建委怎样判断问题、学习能力、做决策、看待商业和行动 | 用户明确要求调用建委思考、判断或商业认知时，先进入 `cognition/` |
...
- 只有用户明确要求“模仿建委本人说话、个人口吻、个人思考或商业认知”时，才需要把个人事实和 `cognition/` 作为额外层；AI 表达本身仍然默认适用生成任务。
