...
- 新增长期项目档案 [`projects/paid-community-course/`](../projects/paid-community-course/)：记录建委正在研发的 399 元 / 3 个月付费社群课程项目，首期方向为 AI 编程，交付形态包括直播、课程和飞书教程。
- 明确边界：具体教程正文写入飞书文档；GitHub 上下文仓库只记录课程研发、项目边界、自媒体流量入口和后续可持续沉淀的资料结构。
- 新增 [`media-growth.md`](../projects/paid-community-course/media-growth.md) 作为自媒体资料入口，用于后续沉淀账号规划、选题、口播稿、文案方法和转化路径。
