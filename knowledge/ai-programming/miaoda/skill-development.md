...
> 来源：百度秒哒 26 年官方更新日志，2026.06.24 — V3.2。

V3.2 上线后，秒哒支持在任意项目中通过对话生成、编辑专属技能。这个能力适合快速创建项目内临时工具、封装常用 API、把重复操作沉淀成可复用技能。
...
- **对话生成后要反查结构**：要求秒哒回贴技能目录结构、入口脚本、环境变量名、入参/出参格式，确认没有遗漏
