...
- [Awesome Seedance · AI视频提示词与案例库](./awesome-seedance/README.md)：按镜头需求选择25类模板，保留原始案例、Skill与复测状态；与既有实战经验组合，按需读取。
...
2. 按已有教学设计、逐字稿或音频拆出制作单元、镜头编号、信息点、预计／实际时长、画面动作与素材依据，标明人工设计、实拍、AI 生成或合成方式；不是每个镜头都要生成。按本片型需要记录原文、素材、提示词、状态和验收。
