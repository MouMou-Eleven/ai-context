...
Skill是能力依赖，不是业务项目归属。商单与实践事实进入[项目与案例](../../../projects/README.md)，视频方法从[设计视频](../../design/video/README.md)读取；名称中的“community/社群”不表示某个课程事实属于会员课程。一个主任务可按需要引用多个能力卡，相关领域只保留链接，不复制实体。
