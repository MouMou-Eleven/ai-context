...
| [`case-result-narrative.md`](./case-result-narrative.md) | 用证据支撑商业价值与结果承接 | 案例明确用于招生、销售、商业提案或产品价值证明；纯教学不触发 |
...
- 新经验按[写入流程](../../../../../system/repository/ingestion-workflow.md)同步最近与上层入口；触发范围变化时更新路由登记并生成llms，治理边界变化才修改AGENTS，不在多处复制方法。
