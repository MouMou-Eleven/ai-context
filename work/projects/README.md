...
以下保留自迁移前c28a8e2项目索引，表示已有源码位置记录，本轮未重新验证各源码项目的线上状态或开发进度：

| 对象 | 已记录位置 | 继续任务时 |
|---|---|---|
| 言剪AI | [MouMou-Eleven/yancut-ai](https://github.com/MouMou-Eleven/yancut-ai) | 先读[上下文项目](./yancut-ai/README.md)，源码以项目当前声明为准 |
