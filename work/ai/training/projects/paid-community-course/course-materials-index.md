...
| 【06】第4课 · 用 AI 做出并发布一个静态网页 | [飞书 Wiki](https://hv21wf9uao9.feishu.cn/wiki/Pwo5wdyFIiB9qVkjFvVclENVnOf?from=from_copylink) | 第一季度课程学员，以非程序员和 AI 协作初学者为主 | 用盒子和可见变化解释 HTML、CSS、JavaScript、托管与域名；提供个人简介、数据大屏、生日贺卡和多文件项目提示词，并讲解开发者工具、单文件/多文件部署、MCP 与 GitHub Pages | 待复核：飞书 revision 8 已完成目录、图片、画板、提示词和敏感信息回读；社群静态托管平台公开前台入口与实际按钮路径仍待课程侧提供后核验 | 2026-08-23 |
