...
| 【07】第5课 · 网页背后的常识：图床、服务器、域名、备案 | [飞书 Wiki](https://hv21wf9uao9.feishu.cn/wiki/RFYCwIPd0i7CeZk8e0ycT7Q2nuR?from=from_copylink) | 第一季度课程学员，以非程序员和 AI 协作初学者为主 | 承接第4课静态网页并为第6课秒哒做准备；按对象存储、数据库、服务器、一次点外卖的生活化串联、域名、DNS、SSL、备案和秒哒迁移组织内容。购买页只保留普通人当前需要理解的参数，并说明它们会影响什么使用和决定 | 已发布：按两轮真实授课反馈完成重构，飞书 revision 82；顶部视频和原有图片保留，新增对象存储与数据库分工、只能浏览与可以下单、一次点外卖3张机制图，回读共16张图片；旧报名案例、前置术语堆叠和定义式参数表已改写 | 2026-09-01 |
| 【08】第6课 · 别让 Bug 打败你：秒哒故障定位与修复实战 | [飞书 Wiki](https://hv21wf9uao9.feishu.cn/wiki/VYsjwFhN3iwq4MkMVHBc8wttnTc?from=from_copylink) | 第一季度课程学员，以非程序员和 AI 协作初学者为主 | 从页面现象出发，按口述、控制台（Console）、元素（Elements）、网络（Network）、录屏、平台约束、分批修复和应用内诊断日志逐层升级；配套一个可运行的 Bug 修复训练台，形成证据、最小修复、回归验收和清理诊断闭环 | 已发布：飞书 revision 105；回读确认 12 个一级章节、1 份最新版可下载 HTML 附件、2 张原有图片、中英文术语对照，以及 200/400/500 离线教学模拟与真实 Network 面板的边界 | 2026-09-09 |
