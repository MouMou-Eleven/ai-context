...
| 【07】第5课 · 网页背后的常识：图床、服务器、域名、备案 | [飞书 Wiki](https://hv21wf9uao9.feishu.cn/wiki/RFYCwIPd0i7CeZk8e0ycT7Q2nuR?from=from_copylink) | 第一季度课程学员，以非程序员和 AI 协作初学者为主 | 承接第4课静态网页并为第6课秒哒做准备；按对象存储、数据库、服务器、一次点外卖的生活化串联、域名、DNS、SSL、备案和秒哒迁移组织内容。购买参数重点解释选小、用完或选错后网站会发生什么 | 已发布：按两轮真实授课反馈完成重构，飞书 revision 82；顶部视频和原有图片保留，新增对象存储与数据库分工、只能浏览与可以下单、一次点外卖3张机制图，回读共16张图片；旧报名案例、前置术语堆叠和定义式参数表已改写 | 2026-09-01 |
