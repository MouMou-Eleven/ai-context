...
| 【07】第5课 · 网页背后的常识：图床、服务器、域名、备案 | [飞书 Wiki](https://hv21wf9uao9.feishu.cn/wiki/RFYCwIPd0i7CeZk8e0ycT7Q2nuR?from=from_copylink) | 第一季度课程学员，以非程序员和 AI 协作初学者为主 | 从“AI 已经会做，为什么普通人还要理解”切入，解释图床与对象存储、静态网页与带数据网页、数据库、云服务器、域名、DNS、SSL 和备案；重点拆解腾讯云对象存储资源包、数据库存储与连接参数、服务器地域、实例规格、磁盘、内网带宽、PPS 和公网带宽，并说明这些角色在秒哒中仍然存在 | 已发布：按真实授课反馈完成重构，飞书 revision 53；回读确认顶部视频、12 张原图和全部购买 / 官方文档链接保留，旧提示词、过度免责声明及重复概念收束章节已删除 | 2026-08-31 |
