...
| role-adaptive-workbench | [`role-adaptive-workbench/skill/SKILL.md`](./role-adaptive-workbench/skill/SKILL.md) | [`role-adaptive-workbench/upstream.json`](./role-adaptive-workbench/upstream.json) | 根据任意身份通过少轮对话生成完整、跨端、可落地的 AI 工作台设计 |
