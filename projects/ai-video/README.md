...
本目录是建委的长期 AI 视频工作领域，用于沉淀具体制作经验和可跨项目复用的方法。单个客户项目资料较多时，再在本目录建立独立子目录。
...
- 不要把本目录内容与 [`../../history/archived-projects/videoai/`](../../history/archived-projects/videoai/README.md) 混淆；后者是已归档的 VideoAI 产品历史资料，本目录是持续维护的 AI 视频工作领域。
