...
|---|---|---|---|
| 多段视频或微课需要集中试听音频、查看参考图、复制提示词、记录状态与返工时 | [视频与微课交互式制作工作台](../../../work/domains/design/video/common/interactive-production-workbench.md) | 一两个简单镜头可用短分镜表；最终成片播放、多人云端协作和权限审核另用对应工具 | 实际测试分段音频、提示词复制、图片路径、段落锚点、状态反馈和窄屏布局；网页打开不能替代交互与成片验收 |
