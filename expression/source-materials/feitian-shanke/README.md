...
2. 再读 [`../../methods/problem-driven-technical-explanation.md`](../../methods/problem-driven-technical-explanation.md)，吸收已经提炼的叙事和讲解规则。
...
| 文件 | 内容 | 何时读取 |
|---|---|---|
| [`../../methods/problem-driven-technical-explanation.md`](../../methods/problem-driven-technical-explanation.md) | 从本资料和后续优秀案例持续提炼的通用讲解方法 | 编写技术科普、课程知识解释和口播内容时 |
